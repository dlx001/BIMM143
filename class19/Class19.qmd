...
filter(ig1, antigen=="FIM2/3") %>%
  ...
  theme_bw()
```
Q16) over time the antigen levels of the aP are significantly growing over time compared to the wP. In both the antigen level increases over time

Q17) aP has higher antigen level over time comapred to wP 
...
No the ab titer data shows continuous increase instead of the peak there is at visit 4
Maybe maximum expression occurs at visit 4 and the consequences of this peak expression is seen
over time by the gradual increase in ab titer.
